...
# Now we loop for every challenge and we test, evaluate, extract and plot the videos and its metrics  
...
python tools/plot_dataset_stats.py --path_to_dataset "./testing_dataset/top${cutoff_challenge}_vids_challenge"
